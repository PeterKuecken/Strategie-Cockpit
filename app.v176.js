...
function renderDailyOverview(s){
  ...
  view.innerHTML=`
    <div class="card dashboard-intro"><p class="eyebrow">Tagesübersicht</p><h2>${crmGreeting(person)}</h2><p>Du siehst hier nur Kontakte und Termine, die jetzt bearbeitet werden müssen. Ein Klick öffnet die passende Arbeitsliste.</p></div>
