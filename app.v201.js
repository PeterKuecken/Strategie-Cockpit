...
function renderSettings(s){
  ...
  view.innerHTML=`
    ...
    <div class="settings-grid" id="settingsMainGrid">
      <section class="card settings-card"><h3>1. Datensicherung erstellen</h3><p>Exportiert Kontakte, Aufgaben, Aktivitäten, Kennzahlen und Veröffentlichungsstände als JSON-Datei.</p><button id="settingsExportButton" class="primary" type="button" onclick="appExportBackup()">Datensicherung exportieren</button></section>
