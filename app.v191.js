...
function renderProcessManager(person){
  ...
  return `<div class="card process-manager"><div class="section-title-row"><div><p class="eyebrow">Version 1.9.1</p><h3>Kontakte nach Arbeitspriorität</h3></div><span class="badge">${all.length} offene Aufgaben</span></div>
