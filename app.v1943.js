...
function knowledgeAllTemplates(){return knowledgeUniqueTemplates([...PERSON_PHASE_TEMPLATES,...knowledgeLibraryTemplates(),...KNOWLEDGE_TEMPLATES])}
...
function renderAssistantPage(s){
  ...
  view.innerHTML=`<div class="card assistant-page-head"><p class="eyebrow">Version 1.9.3</p><h2>${esc(s.title)}</h2><p>${esc(s.text||'')}</p><div class="smart-priority-summary">${(()=>{const x=crmSmartPriorityCounts(crmDashboardContacts());return `<span class="smart-priority smart-priority-red">${x.red} heute</span><span class="smart-priority smart-priority-orange">${x.orange} bald</span><span class="smart-priority smart-priority-green">${x.green} im Plan</span>`})()}</div></div>
...
function renderProcessManager(person){
  ...
  return `<div class="card process-manager"><div class="section-title-row"><div><p class="eyebrow">Version 1.9.3</p><h3>Kontakte nach Arbeitspriorität</h3></div><span class="badge">${all.length} offene Aufgaben</span></div>
